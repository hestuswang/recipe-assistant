...
def main():
    ...
    user_input = "Hello, I want to have some fruit for today's dinner, especially banana and apples. Do you have any recommendations?"  # Get user input from the command line
